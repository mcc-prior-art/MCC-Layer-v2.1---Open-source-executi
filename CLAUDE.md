...
│   ├── INTEGRATION_CONTRACT.md ← PR #43: official framework-neutral integration contract — canonical flow, Mermaid sequence diagram, 5 stages (Proposal/Decision/Verification/Execution/Audit), integration steps, trust boundaries, failure modes (all fail-closed), security guarantees; points at mcc_client + reference agent as THE reference (no framework-specific abstraction)
