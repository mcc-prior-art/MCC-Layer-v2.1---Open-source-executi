...
| Network-segmentation guarantee (attacker with raw network access to upstream) | **NOT IMPLEMENTED** (explicitly out of scope, stated) | 71A | `docs/EXCLUSIVE_EXECUTION_PATH.md`'s A6 caveat |
